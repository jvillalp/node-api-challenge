...
- [x] Mention two parts of Express that you learned about this week.
        ...
        The two parts of Express that we learn this week are Routing and Middleware.

        Routing can help us map incoming requests to the appropriate request handler based on the URL and HTTP method used. Can be used to perform CRUD
        ...
        Middleware is a big part of Express: most of the code we write, like route handlers, includes middleware. This is an array of functions that get executed in the order they are introduced inot the server code. 

            Examples are morgan, cors, helmet & custome middleware.


- [x] Describe Middleware?

        This is an array of functions that get executed in the order they are introduced into the server code. 
